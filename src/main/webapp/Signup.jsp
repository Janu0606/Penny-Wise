        ...
        <div class="auth-card">
            ...
            <form action="SignupServlet">
                <div class="form-group">
                    ...
                    <input type="text" id="signup-name" name="userName" class="form-input" placeholder="Enter your full name" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="signup-password" name = "password"class="form-input" placeholder="Choose a password" required>
                </div>
                <div class="form-group">
